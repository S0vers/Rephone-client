    ...
    return (
        <div className="hero min-h-screen" style={{ backgroundImage: `url(${ewaste})` }}>
            ...
            <div className="hero-content  text-neutral-content text-center">
                <div className="">
                    <h1 className="mb-5 text-5xl font-bold">Electronic Waste</h1>
                    ...
                    <div className="stats stats-vertical lg:stats-horizontal shadow bg-opacity-60">
                        ...
                        <div className="stat">
                            <div className="stat-title text-blue-700"><FiSmartphone></FiSmartphone></div>
                            <div className="stat-value">5000</div>
                            <div className="stat-desc text-blue-700">Phones Sold</div>
                        </div>

                        <div className="stat">
                            <div className="stat-title text-green-700"><FaLeaf></FaLeaf></div>
                            <div className="stat-value">4,900</div>
                            <div className="stat-desc text-green-700">Trees Planted</div>
                        </div>
                    </div>
                </div>
            </div>
